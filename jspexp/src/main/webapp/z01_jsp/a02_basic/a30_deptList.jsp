...
<script type="text/javascript">
	window.onload = function() {
		document.querySelector("h3").innerText="부서정보 조회";
	}
...
부서리스트 화면
1) 버튼
2) 이벤트함수 - location.href

부서등록화면
1) 등록화면 구성
2) 요청값 처리
3) 등록을 위한 요청값으로 VO 만들기
...
<%
 	...
 	if(loc==null) loc = "";
 	// 3. 데이터 처리 결과 받기..
 	A05_PreparedDao daoi = new A05_PreparedDao();
 	List<Dept> dlist = daoi.getDeptList(new Dept(0,dname,loc));
