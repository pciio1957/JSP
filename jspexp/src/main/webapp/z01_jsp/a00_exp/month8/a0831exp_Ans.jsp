...
2. [jstl] forTokens의 속성들을 기술하기
	...
	3) delims : 구분자 
	4) varStatus : idnex(0부터), count(1부터), first, last 등 효과적인 변수를 활용 가능
